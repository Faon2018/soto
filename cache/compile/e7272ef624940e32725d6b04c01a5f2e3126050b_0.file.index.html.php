<?php
/* Smarty version 3.1.30, created on 2019-06-03 08:10:35
  from "D:\www\yafapp\soto\application\views\admin\index\index.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5cf4d5fb9f60d0_45643822',
...
function content_5cf4d5fb9f60d0_45643822 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <div class="main-layout-side">
        ...
        <ul class="layui-nav layui-nav-tree" lay-filter="leftNav">
            <li class="layui-nav-item">
                <a href="javascript:;"><i class="iconfont">&#xe604;</i>标签管理</a>
            </li>
            <li class="layui-nav-item">
            ...
            <div class="layui-tab layui-tab-brief main-layout-tab" lay-filter="tab" lay-allowClose="true">
                ...
                <div class="layui-tab-content">
                    <div class="layui-tab-item layui-show" style="background: #f5f5f5;">
                        <!--1-->
                        <iframe src="/admin/index/welcome/" width="100%" height="100%" name="iframe" scrolling="auto" class="iframe" framborder="0"></iframe>
                        <!--1end-->
                    </div>
                </div>
            </div>
